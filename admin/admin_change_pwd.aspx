<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_change_pwd.aspx.cs" Inherits="admin_admin_change_pwd" %>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            <li class="active"><a href="admin_change_pwd.aspx">更改密码</a></li>            
